...
public class TransactionController {
	 ...
	 */
	@GetMapping(path = "/get-transaction-by-id/{customerId}")
	public ResponseEntity<Response<List<TransactionDetails>>> getTransactionById(@PathVariable String customerId){
